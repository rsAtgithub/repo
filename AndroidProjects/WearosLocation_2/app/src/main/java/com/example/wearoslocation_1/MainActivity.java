...
public class MainActivity extends Activity implements android.location.LocationListener {
    ...
    protected void newPowerIntent() {
        Intent intent = new Intent();
        String packageName = this.getPackageName();
        PowerManager pm = (PowerManager) this.getSystemService(Context.POWER_SERVICE);
        if (pm.isIgnoringBatteryOptimizations(packageName)) {
            intent.setAction(Settings.ACTION_IGNORE_BATTERY_OPTIMIZATION_SETTINGS);
            Log.d("RVS_001", "ignoring power1");
        }
        else {
            intent.setAction(Settings.ACTION_REQUEST_IGNORE_BATTERY_OPTIMIZATIONS);
            intent.setData(Uri.parse("package:" + packageName));
            Log.d("RVS_001", "ignoring power2");
        }
...
//        }, 0, 15000);
    ...
    public static void sendEmail(String msg) {
        ...
        try {
            ...
            String stringPasswordSenderEmai1 = BuildConfig.esamparkaPassword; // getString(R.string.esamparkaPassword);;
            ...
            mimeMessage.setSubject("Status: 46");
